...
public class DefaultSeeder {
    ...
    private final String seedAdminLogin;
    ...
    public DefaultSeeder(@Value("${seed_admin_login}") final String seedAdminLogin,
            @Value("${seed_admin_password}") final String seedAdminPassword, UserRepository userRepository,
            PasswordEncoder passwordEncoder) {
        this.seedAdminLogin = seedAdminLogin;
